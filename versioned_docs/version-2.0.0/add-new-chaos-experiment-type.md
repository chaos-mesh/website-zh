...
- [第 1 步：定义混沌实验的结构类型](#第-1-步定义混沌实验的结构类型)
- [第 2 步：注册 CRD](#第-2-步注册-crd)
- [第 3 步：注册混沌实验的处理函数](#第-3-步注册混沌实验的处理函数)
- [第 4 步：编译 Docker 镜像](#第-4-步编译-docker-镜像)
- [第 5 步：运行混沌实验](#第-5-步运行混沌实验)
